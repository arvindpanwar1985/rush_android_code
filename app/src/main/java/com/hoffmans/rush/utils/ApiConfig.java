...
public class ApiConfig {
    ...
    private static final String QA_URL = "http://rushpanama.net";
   ...
   //public static final String DEV_BASE_URL="http://192.168.1.150:3000"; //pravesh's IP
    ...
    public static final String PRIVACY_URL= getTestUrl()+"/privacy_policy?";
    public static final String TERMS_URL= getTestUrl()+"/terms?";
    public static final String URL_SOCKET="ws://qa.rushpanama.net/socket";
    //public static final String URL_SOCKET_LOCAL="ws://192.168.3.210:8080/";
}
